...
<body>
            ...
            <div class="main-container">
                        ...
                        <div class="aside">
                                    <div class="container">
                                                ...
                                                <ul class="nav">
                                                            ...
                                                            <li><a href="#AddNewCar"><i class="fa fa-car"></i>Add new cars</a></li>
                                                                                    ...
                                                                                    <div class="row">
                                                                                                <div class="card" style="width: 18rem;">
                                                                                                            <div class="card-body">
                                                                                                                        ...
                                                                                                                        <!-- <a href="#Register"></a> -->
                                                                                                                        <button class="btn btn-primary" onclick="registerBtnClick()">Register</button>
                                                                                                            </div>
                                                                                                </div>
                                                                                                <div class="card" style="width: 18rem;margin-left: 20px;">
                                                                                                            <div class="card-body">
                                                                                                                        ...
                                                                                                                        <!-- <a href="#LogIn"></a> -->
                                                                                                                        <button class="btn btn-primary"  onclick="logInBtnClick()">Log In</button>
                                                                                                            </div>
                                                                                                </div>
                                                                                    </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="section-content padd-15 hidden" id="Register">
                                                                                    <div class="row">
                                                                                                <form class="padd-15">
                                                                                                            ...
                                                                                                            <button type="submit" class="btn btn-primary" id="AdminRegistration">Register</button>
                                                                                                </form>
                        ...
                        <!-- home end -->
                        <!-- Add new car start -->
                        <div class="section add-new-car" id="AddNewCar">
                                    <div class="container">
                                                <div class="row">
                                                            <div class="section-title padd-15">
                                                                        <h2>Add new car</h2>
                                                                        ...
                                                                        <div class="row">
                                                                                    <form class="padd-15">
                                                                                                <div class="row mb-3">
                                                                                                            ...
                                                                                                            <div class="col-sm-10">
                                                                                                                        <input type="text" placeholder="Vehicle model" id="model">
                                                                                                            </div>
                                                                                                </div>
                                                                                                <div class="row mb-3">
                                                                                                            <label for="Vehicle number" class="col-sm-2 col-form-label">Vehicle number</label>
                                                                                                            <div class="col-sm-10">
                                                                                                                        <input type="text" placeholder="Vehicle number" id="number">
                                                                                                            </div>
                                                                                                </div>
                                                                                                <div class="row mb-3">
                                                                                                            <label for="Seat capacity" class="col-sm-2 col-form-label">Seat capacity</label>
                                                                                                            <div class="col-sm-10">
                                                                                                                        <input type="number" placeholder="Seat capacity" id="seat">
                                                                                                            </div>
                                                                                                </div>
                                                                                                <div class="row mb-3">
                                                                                                            <label for="Rent per day" class="col-sm-2 col-form-label">Rent per day</label>
                                                                                                            <div class="col-sm-10">
                                                                                                                        <input type="number" placeholder="Rent per day"  id="rent">
                                                                                                            </div>
                                                                                                </div>
                                                                                                <button type="submit" class="btn btn-primary" id="addNewCar">Add</button>
                                                                                    </form>
                                                                                    <div class="alert alert-primary hidden" id="show3" role="alert">
                                                                                                            Add new car SuccessFull
                                                                                                </div>
                                                                        </div>
                                                            </div>
                                                </div>
